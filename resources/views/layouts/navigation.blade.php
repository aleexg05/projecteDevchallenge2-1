<nav x-data="{ open: false }" class="bg-transparent border-b border-white/20" style="background: rgba(26, 11, 46, 0.8); backdrop-filter: blur(10px);">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <!-- Pots afegir enllaços aquí si vols -->
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden" style="background: rgba(26, 11, 46, 0.95);">
